/*
  ...
  - Added the required column `sessionid` to the `ExternalAccount` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ExternalAccount" ("id", "password", "proxy", "userId", "username") SELECT "id", "password", "proxy", "userId", "username" FROM "ExternalAccount";
